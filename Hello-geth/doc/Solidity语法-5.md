* ref to: https://geth.ethereum.org/docs/dapp/native

# Go SDK 调用投票合约

## 以dev模式启动geth，最后带上--datadir参数，此时默认账户的keyStore文件会自动存到./tmpdata目录下，并且这个默认账户keyStone的保护密码是空字符串

~~~
geth --dev --http --http.api eth,web3,personal,net --http.corsdomain="package://6fd22d6fe5549ad4c4d8fd3ca0b7816b.mod" --datadir ./tmpdata
~~~
...
https://github.com/YongYuIT/Go-Stu/tree/master/Hello-geth/Ballot
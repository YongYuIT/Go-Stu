// Package TestHelloApp comment
// This file was generated by tars2go 1.1.4
// Generated from Servant.tars
package TestHelloApp
...
//TestHelloServant struct
type TestHelloServant struct {
	s m.Servant
}

//Add is the proxy function for the method defined in the tars file, with the context
func (_obj *TestHelloServant) Add(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloServant) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloServant) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloServant) Sub(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloServant) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloServant) SubOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloServant) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *TestHelloServant) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

//TarsSetProtocol sets the protocol for the servant.
func (_obj *TestHelloServant) TarsSetProtocol(p m.Protocol) {
	_obj.s.TarsSetProtocol(p)
}

//AddServant adds servant  for the service.
func (_obj *TestHelloServant) AddServant(imp _impTestHelloServant, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *TestHelloServant) AddServantWithContext(imp _impTestHelloServantWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impTestHelloServant interface {
	Add(a int32, b int32, c *int32) (ret int32, err error)
	Sub(a int32, b int32, c *int32) (ret int32, err error)
}
type _impTestHelloServantWithContext interface {
...
func (_obj *TestHelloServant) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	...
	case "Add":
		...
		if _withContext == false {
			_imp := _val.(_impTestHelloServant)
			_funRet_, err = _imp.Add(a, b, &c)
		} else {
			_imp := _val.(_impTestHelloServantWithContext)

// Package TestHelloApp1 comment
// This file was generated by tars2go 1.1.4
// Generated from Servant.tars
package TestHelloApp1
...
//TestHelloSvan struct
type TestHelloSvan struct {
	s m.Servant
}

//Add is the proxy function for the method defined in the tars file, with the context
func (_obj *TestHelloSvan) Add(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloSvan) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloSvan) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloSvan) Sub(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloSvan) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloSvan) SubOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *TestHelloSvan) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *TestHelloSvan) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

//TarsSetProtocol sets the protocol for the servant.
func (_obj *TestHelloSvan) TarsSetProtocol(p m.Protocol) {
	_obj.s.TarsSetProtocol(p)
}

//AddServant adds servant  for the service.
func (_obj *TestHelloSvan) AddServant(imp _impTestHelloSvan, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *TestHelloSvan) AddServantWithContext(imp _impTestHelloSvanWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impTestHelloSvan interface {
	Add(a int32, b int32, c *int32) (ret int32, err error)
	Sub(a int32, b int32, c *int32) (ret int32, err error)
}
type _impTestHelloSvanWithContext interface {
...
func (_obj *TestHelloSvan) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	...
	case "Add":
		...
		if _withContext == false {
			_imp := _val.(_impTestHelloSvan)
			_funRet_, err = _imp.Add(a, b, &c)
		} else {
			_imp := _val.(_impTestHelloSvanWithContext)
